<?php
// Start session and include maintenance config
session_start();
require_once 'maintenance_config.php';

// Redirect users based on their role if logged in
    ...
    <nav class="navbar custom-navbar navbar-expand-md navbar-light fixed-top" data-spy="affix" data-offset-top="10">
        <div class="container">
            <a class="navbar-brand" href="#">
                <img src="assets/imgs/konferans.png" alt="Conference Logo">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a href="colorlib-regform-7/login.php" class="ml-4 nav-link btn btn-primary btn-sm rounded">Login</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-md-6 pr-md-5 mb-4 mb-md-0">
                    ...
                    <img src="assets/imgs/about.jpg" alt="About" class="w-100 mt-3 shadow-sm">
                </div>
                <div class="col-md-6 pl-md-5">
                    <div class="row">
                        <div class="col-6">
                            <img src="assets/imgs/about-1.jpg" alt="About 1" class="w-100 shadow-sm">
                        </div>
                        <div class="col-6">
                            <img src="assets/imgs/about-2.jpg" alt="About 2" class="w-100 shadow-sm">
                        </div>
                        <div class="col-12 mt-4">
                            ...
                            <p><b>Join us in redefining the conference experience. Let's work together to create memorable and impactful events that inspire, educate, and connect.</b><br></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="section" id="live-sessions">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card mb-4">
                        <img src="assets/imgs/1.jpg" alt="Session 1" class="card-img-top">
                        <div class="card-body">
                            ...
                            <img style="width: 150px; margin-left: -15px;" src="assets/imgs/QR_code.svg" alt="">
                            <br>
                ...
                <div class="col-md-4">
                    <div class="card mb-4">
                        <img src="assets/imgs/2.jpg" alt="Session 2" class="card-img-top">
                        <div class="card-body">
                            <span class="badge badge-warning">Live</span>
                ...
                <div class="col-md-4">
                    <div class="card mb-4">
                        <img src="assets/imgs/3.jpg" alt="Session 3" class="card-img-top">
                        <div class="card-body">
                            <span class="badge badge-warning"> Live</span>
